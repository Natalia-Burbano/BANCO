...
import com.example.bancouq.model.*;
...
public class CajeroControllerTest {
    ...
    private CajeroViewController cajeroController;
    private ObservableList<Cliente> clientes;

    @BeforeEach
    public void setUp() throws Exception {
        // Inicializar controlador
        cajeroController = new CajeroViewController();
        ...
        Field clientesField = CajeroViewController.class.getDeclaredField("clientes");
